...
namespace LifeHashTreeTest
{
	...
	static void testInsertRetrieve(LifeHashTree& tree, std::vector<CellValue> values, bool expectSuccess = true)
	{
	...
	static const std::vector<CellValue> clockwiseInsertionValues{
		{0,0,1},
		{0,-1,2},
		{-1,-1,3},
		{-1,0,4},
	...
	static const std::vector<CellValue> clockwiseNewValues{
	{0,0,11},
	{0,-1,12},
	{-1,-1,13},
	{-1,0,14},
	...
	static const std::vector<CellValue> largeCellValues{
		{1, 1, 5},
		{0, 1, 10},
		{1, 0, 120},
		{ -1, 1, 255 },
	...
	static std::vector<CellValue> outOfRangeCellValues
	{
		{1,1,256},
		{2,2,2000},
		{3,3,-1},
	...
	static std::vector<CellValue> zeroValues
	{
		{0,0,0},
		{0,-1,0},
		{-1,-1,0},
